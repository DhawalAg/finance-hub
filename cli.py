"""CLI surface over the tool registry.
    ...
    hub tools                       list every registered tool
    hub run <name> --args '<json>'  invoke a tool with JSON kwargs
"""
...
app = typer.Typer(help="hub-hub: run any registered capability from the shell.")
registry.load_all()
