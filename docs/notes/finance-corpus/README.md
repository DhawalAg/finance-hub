# Finance Corpus Notes

This directory holds raw intake, working notes, and decision history for Finance Hub.

These files are not implementation contracts. Durable decisions should be promoted into:
